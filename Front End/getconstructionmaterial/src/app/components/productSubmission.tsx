...
const ProductSubmissionComponent: React.FC = () => {
  ...
  return (
    <div className="flex flex-col lg:w-[1000px]">
      ...
      <input type="search" name="material" value={formData.material} onChange={handleChange} placeholder="Material/Product wanted" className="sm:flex items-stretch flex-grow lg:border-r border-b-2 lg:border-b-0 focus:outline-none block rounded-lg lg:rounded-none lg:rounded-l-lg pl-4 py-2 dark:bg-white"></input>
      <input type="email" name="email" value={formData.email} onChange={handleChange} placeholder="E-mail Address" className="sm:flex items-stretch flex-grow sm:border-r border-b-2 lg:border-b-0 focus:outline-none block rounded-lg lg:rounded-none pl-4 py-2 dark:bg-white"></input>
      <input type="search" name="loc" value={formData.loc} onChange={handleChange} placeholder="City and Province" className="sm:flex items-stretch flex-grow focus:outline-none rounded-lg lg:rounded-none block pl-4 py-2 dark:bg-white"></input>  
